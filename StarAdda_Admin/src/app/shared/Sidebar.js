    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <div className="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a className="brand-logo" href="/dashboard"></a>
                  ...
                  <ul className="nav flex-column sub-menu">
                    ...
                    {/* {this.props.allAdmins && (
                      <li className="nav-item">
                        ...
                        <Link
                          className={
                            this.isPathActive('/admin/sitesettings')
                              ? 'nav-link active'
                              : 'nav-link'
                          }
                  ...
                  <ul className="nav flex-column sub-menu">
                    ...
                    {/* {this.props.newUser && (
                      <li className="nav-item">
                        ...
                        <Link
                          className={
                            this.isPathActive('/user/adduser')
                              ? 'nav-link active'
                              : 'nav-link'
                          }
                          to="/user/adduser"
                  ...
                  <ul className="nav flex-column sub-menu">
                    ...
                    {/* {this.props.allDepositRequests && (
                      <li className="nav-item">
                        ...
                        <Link
                          className={
                            this.isPathActive('/transaction/alldeposits')
                              ? 'nav-link active'
                              : 'nav-link'
                          }
                          to="/transaction/alldeposits"
                        >
                  ...
                  <ul className="nav flex-column sub-menu">
                    ...
                    {/* {this.props.depositReport && (
                      <li className="nav-item">
                        ...
                        <Link
                          className={
                            this.isPathActive('/Reports/deposit_report')
                              ? 'nav-link active'
                              : 'nav-link'
                          }
                          to="/Reports/depositReport"
                        >
