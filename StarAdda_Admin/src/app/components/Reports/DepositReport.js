          ...
          <div className="">
            ...
            >
              <div className="flex_center_between">
                <h4 className="other_page_cards_heading">Deposit Reports</h4>
                <select
                        ...
                        <div id="printablediv">
                          ...
                          <Row style={{ marginTop: 48 }}>
                            <div>
                              ...
                              <h6>
                                {' '}
                                {data.User_id && data.User_id.holder_name
                                  ? data.User_id?.holder_name
                                  : data.User_id?.Name}
                              </h6>
                              <h6>{data.User_id ? data.User_id.Phone : ''} </h6>
                            </div>
                          </Row>
