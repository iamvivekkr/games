...
function Views() {
  ...
  const CancelGame = async () => {
    ...
    if (confirm) {
      ...
      axios
        .patch(
          baseUrl + `challange/Cancel/admin/${path}`,
  ...
  const updateadmin = async (id) => {
    ...
    if (confirm) {
      ...
      axios
        .post(
          baseUrl + `challange/admin/result/${path}`,
          {
            winner: id,
  ...
  return mount ? (
    ...
    >
      <img
        src={`${baseUrl}Images/LandingPage_img/loader1.gif`}
    ...
    <div>
      ...
      {/* new layout start */}
      <div
        className="content d-flex flex-column flex-column-fluid snipcss-Kdfx3"
        id="kt_content"
      >
        {/*begin::Entry*/}
          ...
          <div className="container-fluid">
            <div className={css.row}>
              <div className="col-xl-12">
                ...
                >
                  <div
                    className={css.card_body}
                    style={{ background: "rgba(0,0,0,0.5)" }}
                  >
                    <div className="row">
                      <h3
                        className={`text-white ${css.font_weight_bolder} snip-h3`}
                      >
                        Match Details
                      </h3>

                      {
                        ...
                        game.Status != "cancelled" &&
                          ...
                          game.Status != "running" && (
                            <button
                              onClick={CancelGame}
                              className="btn btn-danger ml-auto rounded-pill"
                            >
                              Cancel Match
                            </button>
                          )
                      ...
                      {game.Created_by?._id == game.Accepetd_By?._id &&
                      game.Status != "cancelled" &&
                      game.Status != "completed" ? (
                        <button
                          onClick={CancelGame}
                    ...
                    <p
                      className={`${css.text_muted} ${css.font_size_lg} mt-5 mb-10 snip-p`}
                    >
                    ...
                    <div className="row">
                      ...
                      >
                        <h4
                          className={`text-white ${css.font_weight_bolder} snip-h4`}
                        >
                      ...
                      >
                        ...
                        >
                          Prize:{" "}
                          {game.Game_Ammount + winnAmount(game.Game_Ammount)}
                        </h4>
                      </div>
                      <div
                        className="col-lg-2"
                      ...
                      <div className="col-lg-2">
                        ...
                        >
                          Status:{" "}
                          <span
                            className={`${css.label} ${css.label_primary} ${css.font_weight_bolder} ${css.label_pill} ${css.label_inline} bg-white text-dark py-3`}
                      ...
                      <div className="col-lg-2">
                        ...
                        >
                          Last Updated By:
                          <span style={{ color: "#f4bc41" }}>
                            {game.action_by ? game.action_by.Name : "N/A"}
                          </span>
                          (
                          <span style={{ color: "#f4bc41" }}>
                            {game.actionby_Date
                              ? dateFormat(game.actionby_Date).split(",")[0]
                              : "N/A"}
                          </span>
                          )
                        </h6>
            ...
            <div className={css.row}>
              <div className="col-lg-6">
                <div
                  className={`${css.card} ${css.card_custom} ${css.card_stretch}  ${css.gutter_b}`}
                >
                  <div className={`${css.card_body} d-flex p-0`}>
                    <div
                      className={`${css.flex_grow_1} ${css.p_12} ${css.card_rounded} ${css.bgi_no_repeat} d-flex flex-column justify-content-center align-items-start`}
                      style={{
                    ...
                    >
                      ...
                      <ul className="snip-ul">
                        <li>
                          User Name:{" "}
                          <Link
                            to={`/user/view_user/${game.Created_by?._id}`}
                        ...
                        <li>
                          Created Time:{" "}
                          {dateFormat(game.createdAt).split(",")[0]}
                        </li>
                        <li>
                          Participant Status:
                          {game.Creator_Status && (
                            <span
                              className={`${css.label} ${
                                game.Creator_Status == "winn"
                                  ? css.label_success
                                  : css.label_danger
                              } ${css.font_weight_bolder} ${css.label_pill} ${
                                css.label_inline
                              } ml-2`}
                            >
                              {game.Creator_Status}
                        ...
                        {game.Creator_Status_Updated_at && (
                          <li>
                            Status Updated At:{" "}
                            {
                              dateFormat(game.Creator_Status_Updated_at).split(
                                ","
                              )[0]
                            }
                          </li>
                      ...
                      <p className="snip-p"></p>
                      {(game.Status == "pending" ||
                        game.Status == "conflict") && (
                        <div className="form-group">
                          <button
                            href="match-summery?partiId=2&aid=4132&mtid=2"
                            className={`btn ${css.btn_success} ${css.font_weight_bold} ${css.py_2} ${css.px_6} mr-2 snip-a`}
                            onClick={() => {
                              updateadmin(game.Created_by?._id);
                            }}
                          >
                            Win
                          </button>
                          <button
                            href="match-summery?partiId=2&rid=4132&mtid=2"
                            className={`btn btn-danger ${css.font_weight_bold} ${css.py_2} ${css.px_6} mr-2 snip-a`}
                            onClick={() => {
                              updateadmin(game.Accepetd_By?._id);
                            }}
                          >
                            Lose
                          </button>
                          ...
                          <div>
                            ...
                            <button
                              ...
                              onClick={() => updatePenalty(game.Created_by._id)}
                            >
                              Add Penalty
                            </button>
                          </div>
              ...
              {game.Accepetd_By && (
                <div className="col-lg-6">
                  <div
                    className={`card ${css.card_custom} ${css.card_stretch}  ${css.gutter_b}`}
                  >
                    <div className={`${css.card_body} d-flex p-0`}>
                      <div
                        className={`${css.flex_grow_1} ${css.p_12} ${css.card_rounded} ${css.bgi_no_repeat} d-flex flex-column justify-content-center align-items-start`}
                      ...
                      >
                        <h2
                          className={`${css.font_weight_bolder} snip-h2 mb-4`}
                        >
                          Acceptor
                        </h2>
                        <ul className="snip-ul">
                          {game.Accepetd_By && (
                            <li>
                              ...
                              <Link
                                to={`/user/view_user/${
                                  game.Accepetd_By && game.Accepetd_By?._id
                                }`}
                                className={`btn ${css.btn_success} ${css.font_weight_bold} ${css.py_2} ${css.px_6} mr-2 snip-a`}
                              >
                          ...
                          <li>
                            Join Time:{" "}
                            {
                              dateFormat(game.Acceptor_by_Creator_at).split(
                                ","
                              )[0]
                            }
                          </li>
                        ...
                        {(game.Status == "pending" ||
                          ...
                          <div className="form-group">
                            <button
                              href="match-summery?partiId=2&aid=8&mtid=2"
                              className={`btn ${css.btn_success} ${css.font_weight_bold} ${css.py_2} ${css.px_6} mr-2 snip-a`}
                              onClick={() => {
                                updateadmin(game.Accepetd_By?._id);
                              }}
                            ...
                            &nbsp;&nbsp;
                            <button
                              href="match-summery?partiId=2&rid=8&mtid=2"
                              className={`btn btn-danger ${css.font_weight_bold} ${css.py_2} ${css.px_6} mr-2 snip-a`}
                              onClick={() => {
                                updateadmin(game.Created_by?._id);
                              }}
                            ...
                            <div>
                              ...
                              <button
                                className="btn btn-sm btn-primary mt-2"
                                onClick={() =>
                                  updatePenalty(game.Accepetd_By._id)
                                }
                              >
                                Add Penalty
                              </button>
