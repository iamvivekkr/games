...
export default function Allchallenge() {
  ...
  const Allchallenge = async () => {
    ...
    axios
      .get(baseUrl + `admin/challange/all?page=${pageNumber}&_limit=${limit}`, {
        headers,
      })
      .then((res) => {
            ...
            <div className="">
              ...
              >
                <div className="flex_center_between">
                  <h4 className="other_page_cards_heading">All Challanges</h4>
                  <select
                      ...
                      {challenge &&
                        challenge.map((game, key) => (
                          <tr key={game._id}>
                            ...
                            <td>
                              <span className="pl-2 ">
                                {game.Created_by ? game.Created_by.Name : null}
                              </span>
                            </td>
