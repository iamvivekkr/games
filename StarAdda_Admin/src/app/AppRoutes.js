...
import Allhistory from "./components/userManagement/Allhistory";
...
const Allchallenges = lazy(() =>
  import("./components/challengeManagement/Allchallenge")
);
...
const Penaltybonus = lazy(() =>
  import("./components/transaction/Penalty&bonus")
);
// const DepositManual = lazy(() => import('./components/transaction/DepositManual'));
...
const AppRoutes = () => {
  ...
  const [depositManual, setDepositManual] = useState(true);
  ...
  const [depositReport, setdepositReport] = useState(true); //Added by team
      ...
      <>
        <Suspense fallback={<Spinner />}>
          <Switch>
            ...
            <Route path="/user/allhistory/:id" component={Allhistory} />
            ...
            {allChallenges && (
              <Route
                path="/challenge/allchallenges"
                component={Allchallenges}
              />
            )}
            {completedChallenges && (
              <Route
                path="/challenge/completed_challange"
                component={Completed}
              />
            )}
            {conflictChallenges && (
              <Route
                path="/challenge/conflict_challange"
                component={Conflict}
              />
            )}
            {cancelledChallenges && (
              <Route
                path="/challenge/cancelled_challange"
                component={Cancelled}
              />
            )}
            {runningChallenges && (
              <Route path="/challenge/running_challange" component={Running} />
            )}
            {newChallenge && (
              <Route path="/challenge/new_challange" component={New} />
            )}
            ...
            {allWithdrawlRequests && (
              <Route
                path="/transaction/allwithdrawl"
                component={Allwithdrawl}
              />
            )}
            {penaltyBonus && (
              <Route
                path="/transaction/penaltybonus"
                r
            ...
            {depositHistory && (
              <Route
                path="/transaction/transaction_history"
                component={Transactionhistory}
              />
            )}
            {bonusHistory && (
              <Route
                path="/transaction/bonus_history"
                component={Bonushistory}
              />
            )}
            {withdrawlHistory && (
              <Route
                path="/transaction/withdraw_history"
            ...
            {/* Added By Team */}
            {bonusReport && (
              <Route path="/Reports/bonusReport" component={BonusReport} />
            )}
            {penaltyReport && (
              <Route path="/Reports/penaltyReport" component={PenaltyReport} />
            )}
            {withdrawalReport && (
              <Route
                path="/Reports/withdrawalReport"
                component={WithdrawalReport}
              />
            )}
            {depositReport && (
              <Route path="/Reports/deposit_manual" component={DepositReport} />
            )}
            {/* Added By Team */}
            {/* Report Routes Start */}
