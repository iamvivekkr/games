...
export default function Pan() {
  ...
  const handleSubmitdata = (e) => {
    ...
    if (addhar.Name && addhar.Number && addhar.docs && addhar.DOB) {
      axios
        .post(`${EndPoint}/pancard`, formData, { headers })
        .then((res) => {
          setaadhar(res.data);
        ...
        <div className={css.main_area} style={{ paddingTop: "60px" }}>
          <div className="p-4">
            ...
            <div className={`text-center ${css.font_7}`}>
              Please update your
              <b>correct pan-card</b>, as we will cut TDS (Tax Deducted at
              Source).
            </div>
            ...
            <div className={`${css.kyc_doc_input} mt-5`}>
              <input
                ...
                onChange={handleChange}
              />
              <div className={css.label}>Pan Card Number:</div>
            </div>
            <div className={`${css.kyc_doc_input} mt-5`}>
              <div className={css.label}>Date of Birth</div>
              <input
                id="dob"
                max="2004-05-05"
                label="Date of Birth"
            ...
            <div className={`${css.doc_upload} mt-5`}>
              ...
              <div className="cxy flex-column position-absolute ">
                <img
                  src={process.env.PUBLIC_URL + "/Images/upload_icon.png"}
                  width="17px"
                  alt=""
                  className="snip-img"
                />
            ...
            <div style={{ paddingBottom: "80px" }} className=""></div>
            <div className={css.refer_footer}>
              <button
                className={`${css.refer_button} ${css.cxy} w-100 ${css.bg_secondary} snip-button`}
              >
                Complete
              </button>
            </div>
